...
public class ExperienciaController implements Initializable {
	...
	@FXML
	void onAddExperienciaButtonAction(ActionEvent event) {
	...
	@FXML
	void onEliminarExperienciaButtonAction(ActionEvent event) {
		Experiencia experienicia = experienciaSeleccionada.get();
		Optional<ButtonType> result = Mensajes.confirmacion("Eliminar titulo",
				"¿Esta seguro de que quiere eliminar esta experiencia " + experienicia.getDenominacion() +", "+experienicia.getEmpleador()+", "+experienicia.getDesde()+", "+experienicia.getHasta()+ "?");
